...
```{r test percentage of partition}
...
```{r check stratification train set to compare with test set}
prop.table(table(train.orig$class))
```

#### D. Class balance for test dataset

```{r check stratification test set to compare with train set}
...
```{r transform train data set,results = 'hide'}
#SMOTE Balanced
...
```{r metrics on original train set}
###################################################
...
```{r train on smote train data set}
...
```{r metrics on smote train dataset}
################################################
...
```{r train on adasyn train dataset}
...
```{r train on dbsmote train dataset}
